...
### 🎨 Компактный дизайн модуля "Личные границы" (NEW!)
Улучшенная мобильная версия для подростков:
- **Компактные карточки** - уменьшены отступы (py-2 вместо py-8), оптимизированы размеры элементов
- **Горизонтальный скролл** - карточки сна и медитации теперь скроллятся горизонтально (Calm-inspired)
- **Улучшенная навигация** - автоскролл к секции "Сон" при клике
- **Liquid Glass эффекты** - применены ко всем интерактивным элементам
- **Меньше места** - все секции занимают меньше вертикального пространства

### 💤 Улучшения SleepMeditationHub
Новый дизайн медитаций и сна:
- **Горизонтальный скролл карточек** - компактные карточки (120px×140px) с реальными изображениями Unsplash
- **Liquid Glass плеер** - красивый стеклянный эффект для аудио-плеера
- **Mood-based рекомендации** - автоматический подбор контента под настроение
- **Убраны упоминания брендов** - удалены все упоминания "Calm" и "Headspace" из UI
